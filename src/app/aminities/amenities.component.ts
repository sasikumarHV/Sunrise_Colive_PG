...
export class AmenitiesComponent {
  ...
  facilities = [
    { icon: 'wifi', name: 'Hi-Speed Wi-Fi', description: 'We provide all facilities including WIFI connection to our occupants throughout the building with high speed.' },
    ...
    { icon: 'chair', name: 'Study Chair', description: 'We provide study chairs for comfortable studying and working.' },
    { icon: 'restaurant_menu', name: 'Food', description: 'We offer food services with a variety of options to cater to different dietary preferences.' }
  ];
